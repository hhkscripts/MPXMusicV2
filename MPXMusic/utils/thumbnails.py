...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("MPXMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("MPXMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("MPXMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("MPXMusic/assets/play_icons.png")
